  ...
  return (
    <div className="shadow-xl bg-white rounded-t-lg text-black text-center font-[Inter] h-full p-[20px]">
        ...
        <div className="text-[10px]">
          ...
          <br />
          <p>看来我的看护人正在找我。如果你可以给 <b>{caregiverName}</b>打一个电话 <span className="text-[#FF6635]">(contact number below)</span> 并指引我回到我家 <span className="text-[#FF6635]">(address below)</span>.</p>
          <br />
